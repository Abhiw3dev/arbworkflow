...
const firstUserFlow = (async () => {
  ...
  if (fs.existsSync(cookiesSlackPath)) {
                ...
                // await slackpage.waitForSelector('button[class="c-button v--primary v--with-dropdown"]', { visible: true })
                // await sleep(2000)
...
console.log('exported OTP from the previous file: ', otpCode)
...
// Paste the OTP from the clipboard into the input field

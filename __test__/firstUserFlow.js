name: Automation firstUserFlowFunction
    ...
    steps:
      ...
      - name: Display Deployed Report Links
        run: |
          ...
          echo "3. Test Console Report: 'https://abhiw3dev.github.io/arbworkflow/coverage-reports/deploy-directory/consoleLogs/test_consoleLog.html'"
